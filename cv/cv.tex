...
\begin{enumerate}[label={[{\arabic*.}]}, left=0.15in]
    \resumeItem{\textbf{Pfänder, J.\footnotemark[1]}, Mede, N. G., & Cologna, V. (2026). Global studies on trust in science suggest new theoretical and methodological directions. \emph{Current Opinion in Psychology}, 67, 102215. \url{https://doi.org/10.1016/j.copsyc.2025.102215}
    }
    \resumeItem{\textbf{Pfänder, J.\footnotemark[1]}, Rouilhan, S. de, & Mercier, H. (2025). Trusting but forgetting impressive science. \emph{Journal of Cognition and Culture}. \url{https://doi.org/10.1163/15685373-12340227}
    }
...
\subsection*{Courses}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{Fact-Checking and Critical Thinking} $|$ \emph{Université PSL (Paris Sciences \& Lettres)}}{2022 -- 2025}
          \resumeItemListStart
...
\resumeSubheading
  {Ad-hoc reviewer for}{}  
  {\parbox[t]{0.9\textwidth}{Nature Climate Change (1), Public Understanding of Science (3), PNAS Nexus (1), Social Science \& Medicine (1), Društvena istraživanja (Croatian social science review) (1), Behavior Research Methods (1), Educational Research Review (1), Artificial Intelligence Review (1) --- \textbf{Total: 10 reviews}}}{}
